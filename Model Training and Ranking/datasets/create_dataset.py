...
def get_split(source_file,num_train,num_test,num_copies,save_path):
...
for g_type in graph_types:
    ...
    get_split(bet_source_file,num_train,num_test,num_copies,save_path_bet)

    #save closeness split
    get_split(close_source_file,num_train,num_test,num_copies,save_path_close)
